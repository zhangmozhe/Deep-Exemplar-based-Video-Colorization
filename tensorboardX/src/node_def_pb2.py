...
_NODEDEF_ATTRENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="tensorboard.NodeDef.AttrEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="tensorboard.NodeDef.AttrEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_NODEDEF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="tensorboard.NodeDef.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="op",
            full_name="tensorboard.NodeDef.op",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="input",
            full_name="tensorboard.NodeDef.input",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="device",
            full_name="tensorboard.NodeDef.device",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="attr",
            full_name="tensorboard.NodeDef.attr",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
