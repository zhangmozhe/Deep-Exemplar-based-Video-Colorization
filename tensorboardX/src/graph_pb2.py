...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        tensorboardX_dot_src_dot_node__def__pb2.DESCRIPTOR,
        tensorboardX_dot_src_dot_versions__pb2.DESCRIPTOR,
    ],
)
...
_GRAPHDEF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="node",
            full_name="tensorboard.GraphDef.node",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="versions",
            full_name="tensorboard.GraphDef.versions",
            index=1,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="version",
            full_name="tensorboard.GraphDef.version",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
