...
_PRCURVEPLUGINDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="version",
            full_name="tensorboard.PrCurvePluginData.version",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="num_thresholds",
            full_name="tensorboard.PrCurvePluginData.num_thresholds",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
...
PrCurvePluginData = _reflection.GeneratedProtocolMessageType(
    "PrCurvePluginData",
    (_message.Message,),
    dict(
