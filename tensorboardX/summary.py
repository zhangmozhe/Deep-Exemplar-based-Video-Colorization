...
from .src.summary_pb2 import HistogramProto, Summary, SummaryMetadata
...
def compute_curve(labels, predictions, num_thresholds=None, weights=None):
    ...
    tp_buckets, _ = np.histogram(
        bucket_indices, bins=num_thresholds, range=histogram_range, weights=float_labels * weights
    )
    fp_buckets, _ = np.histogram(
        bucket_indices, bins=num_thresholds, range=histogram_range, weights=(1.0 - float_labels) * weights
    )
