...
_LOGMESSAGE_LEVEL = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(name="DEBUG", index=1, number=10, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="INFO", index=2, number=20, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="WARN", index=3, number=30, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="ERROR", index=4, number=40, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="FATAL", index=5, number=50, options=None, type=None),
    ],
...
_SESSIONLOG_SESSIONSTATUS = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="STATUS_UNSPECIFIED", index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="START", index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="STOP", index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="CHECKPOINT", index=3, number=3, options=None, type=None),
    ],
    containing_type=None,
    options=None,
...
_EVENT = _descriptor.Descriptor(
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="what", full_name="tensorboard.Event.what", index=0, containing_type=None, fields=[]
        ),
    ],
    serialized_start=78,
    serialized_end=397,
...
_SESSIONLOG = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_SESSIONLOG_SESSIONSTATUS,],
    options=None,
    is_extendable=False,
    syntax="proto3",
    extension_ranges=[],
