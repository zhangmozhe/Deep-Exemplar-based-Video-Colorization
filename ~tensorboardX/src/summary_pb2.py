...
_SUMMARYDESCRIPTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="type_hint",
            full_name="tensorboard.SummaryDescription.type_hint",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_HISTOGRAMPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="min",
            full_name="tensorboard.HistogramProto.min",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="max",
            full_name="tensorboard.HistogramProto.max",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="num",
            full_name="tensorboard.HistogramProto.num",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="sum",
            full_name="tensorboard.HistogramProto.sum",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="sum_squares",
            full_name="tensorboard.HistogramProto.sum_squares",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="bucket_limit",
            full_name="tensorboard.HistogramProto.bucket_limit",
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="bucket",
            full_name="tensorboard.HistogramProto.bucket",
            index=6,
            number=7,
            type=1,
            cpp_type=5,
...
_SUMMARYMETADATA_PLUGINDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="plugin_name",
            full_name="tensorboard.SummaryMetadata.PluginData.plugin_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="content",
            full_name="tensorboard.SummaryMetadata.PluginData.content",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SUMMARYMETADATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="plugin_data",
            full_name="tensorboard.SummaryMetadata.plugin_data",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SUMMARY_IMAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="height",
            full_name="tensorboard.Summary.Image.height",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="width",
            full_name="tensorboard.Summary.Image.width",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="colorspace",
            full_name="tensorboard.Summary.Image.colorspace",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tensorboard.Summary.Image.encoded_image_string",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
...
_SUMMARY_AUDIO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="sample_rate",
            full_name="tensorboard.Summary.Audio.sample_rate",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="num_channels",
            full_name="tensorboard.Summary.Audio.num_channels",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="length_frames",
            full_name="tensorboard.Summary.Audio.length_frames",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tensorboard.Summary.Audio.encoded_audio_string",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="content_type",
            full_name="tensorboard.Summary.Audio.content_type",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_SUMMARY_VALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="node_name",
            full_name="tensorboard.Summary.Value.node_name",
            index=0,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="tag",
            full_name="tensorboard.Summary.Value.tag",
            index=1,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="metadata",
            full_name="tensorboard.Summary.Value.metadata",
            index=2,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="simple_value",
            full_name="tensorboard.Summary.Value.simple_value",
            index=3,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tensorboard.Summary.Value.obsolete_old_style_histogram",
            index=4,
            number=3,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="image",
            full_name="tensorboard.Summary.Value.image",
            index=5,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="histo",
            full_name="tensorboard.Summary.Value.histo",
            index=6,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="audio",
            full_name="tensorboard.Summary.Value.audio",
            index=7,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="tensor",
            full_name="tensorboard.Summary.Value.tensor",
            index=8,
            number=8,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="value", full_name="tensorboard.Summary.Value.value", index=0, containing_type=None, fields=[]
        ),
    ],
...
_HISTOGRAMPROTO.fields_by_name["bucket_limit"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_HISTOGRAMPROTO.fields_by_name["bucket"].has_options = True
_HISTOGRAMPROTO.fields_by_name["bucket"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
