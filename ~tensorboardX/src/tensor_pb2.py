...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        tensorboardX_dot_src_dot_resource__handle__pb2.DESCRIPTOR,
...
_TENSORPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="dtype",
            full_name="tensorboard.TensorProto.dtype",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="tensor_shape",
            full_name="tensorboard.TensorProto.tensor_shape",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="version_number",
            full_name="tensorboard.TensorProto.version_number",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="tensor_content",
            full_name="tensorboard.TensorProto.tensor_content",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="half_val",
            full_name="tensorboard.TensorProto.half_val",
            index=4,
            number=13,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="float_val",
            full_name="tensorboard.TensorProto.float_val",
            index=5,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="double_val",
            full_name="tensorboard.TensorProto.double_val",
            index=6,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="int_val",
            full_name="tensorboard.TensorProto.int_val",
            index=7,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="string_val",
            full_name="tensorboard.TensorProto.string_val",
            index=8,
            number=8,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="scomplex_val",
            full_name="tensorboard.TensorProto.scomplex_val",
            index=9,
            number=9,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="int64_val",
            full_name="tensorboard.TensorProto.int64_val",
            index=10,
            number=10,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="bool_val",
            full_name="tensorboard.TensorProto.bool_val",
            index=11,
            number=11,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="dcomplex_val",
            full_name="tensorboard.TensorProto.dcomplex_val",
            index=12,
            number=12,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tensorboard.TensorProto.resource_handle_val",
            index=13,
            number=14,
            type=11,
            cpp_type=10,
...
_TENSORPROTO.fields_by_name[
    "resource_handle_val"
].message_type = tensorboardX_dot_src_dot_resource__handle__pb2._RESOURCEHANDLEPROTO
...
_TENSORPROTO.fields_by_name["half_val"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TENSORPROTO.fields_by_name["float_val"].has_options = True
_TENSORPROTO.fields_by_name["float_val"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TENSORPROTO.fields_by_name["double_val"].has_options = True
_TENSORPROTO.fields_by_name["double_val"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TENSORPROTO.fields_by_name["int_val"].has_options = True
_TENSORPROTO.fields_by_name["int_val"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TENSORPROTO.fields_by_name["scomplex_val"].has_options = True
_TENSORPROTO.fields_by_name["scomplex_val"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TENSORPROTO.fields_by_name["int64_val"].has_options = True
_TENSORPROTO.fields_by_name["int64_val"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TENSORPROTO.fields_by_name["bool_val"].has_options = True
_TENSORPROTO.fields_by_name["bool_val"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
_TENSORPROTO.fields_by_name["dcomplex_val"].has_options = True
_TENSORPROTO.fields_by_name["dcomplex_val"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\020\001")
)
