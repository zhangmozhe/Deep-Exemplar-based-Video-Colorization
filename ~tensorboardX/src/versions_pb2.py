...
_VERSIONDEF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="producer",
            full_name="tensorboard.VersionDef.producer",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="min_consumer",
            full_name="tensorboard.VersionDef.min_consumer",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="bad_consumers",
            full_name="tensorboard.VersionDef.bad_consumers",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
VersionDef = _reflection.GeneratedProtocolMessageType(
    "VersionDef",
    (_message.Message,),
    dict(
